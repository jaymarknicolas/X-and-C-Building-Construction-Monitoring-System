...
@section('content')
    ...
    <div class="card card-tabs mb-3">
        <div class="card-header">
            ...
            <div>
                <a href="/fund_manager/projects" class="btn btn-outline-dark float-right justify-content-end text-dark"><i
                        class="fa fa-reply-all"></i> Back</a>
                <a href="/fund_manager/project-report/{{ $project->id }}"
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tab2">
                    ...
                    <div class="card-body">
                        {!! Form::open([
                            'action' => 'FundManagerFundController@store',
                            'method' => 'POST',
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="route_name" value="/fund_manager/projects/{{ $project->id }}">
