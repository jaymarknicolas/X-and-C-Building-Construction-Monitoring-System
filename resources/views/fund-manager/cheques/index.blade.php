        ...
        <div class="col">
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    <div class="tools">
                        <a href="/fund_manager/disbursement-cheque-summary" class="btn btn-sm btn-danger mr-3"><i
                                class="fa fa-file-pdf-o"></i> Generate PDF</a>

                        <a href="/fund_manager/cheques/create" class="btn btn-sm btn-primary"><i class="ti-plus"></i> Click
                            To Add New Cheque</a>
                    </div>
                </div>
                @if (count($cheques) > 0)
                                        ...
                                        @foreach ($cheques as $cheque)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="/fund_manager/cheques/{{ $cheque->id }}" class="p-0"><i
                                                            class="fa fa-vcard-o fs-5 text-primary"></i></a>
                                                    <a href="/fund_manager/cheques/{{ $cheque->id }}/edit"
                                                        class="p-0"><i
