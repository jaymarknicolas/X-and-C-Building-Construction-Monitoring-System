...
@section('content')
    ...
    <div class="card px-5">
        {!! Form::open([
            'action' => 'FundManagerChequeController@store',
            'method' => 'POST',
        ...
        <div class="form-group row">
            ...
            <div class="input-group col-md-6 pr-5 mx-auto mt-5 mb-2 offset-md-3">
                ...
                <select class="form-control @error('employee_id') is-invalid @enderror" required autocomplete="employee_id"
                    autofocus name="employee_id" value="{{ old('employee_id') }}">
                    <option value="">Default Select</option>
                    @foreach ($employee_names as $employee_name)
                        <option value="{{ $employee_name->id }}"
                            {{ old('employee_id') == $employee_name->id ? 'selected' : '' }}>
        ...
        <div class="card-footer text-right mx-3 mb-3">
            ...
            <a href="/fund_manager/cheques" class="btn btn-secondary"><i class="ti-close"></i> Cancel</a>
        </div>
    ...
    <div class="modal fade" id="employeeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                {!! Form::open([
                    'action' => 'FundManagerEmployeeNameController@store',
                    'method' => 'POST',
                    'class' => 'row g-3 d-block  needs-validation',
                    'novalidate',
                    'enctype' => 'multipart/form-data',
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="route_name" value="/fund_manager/cheques/create">
                    <div class="form-group row">
                        <div class="input-group col px-5 mx-auto mb-2 offset-md-3">
                            <div class="input-group-prepend">
