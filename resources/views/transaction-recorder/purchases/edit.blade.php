...
@section('content')
    ...
    <div class="card px-5">
        <form action="/transaction_recorder/purchases/{{ $purchase->id }}" method="post">
            @csrf
            @method('PUT')
            <div class="form-group row">
                <div class="input-group col-md-12 px-5 mx-auto mt-5 mb-2 offset-md-3">
                    ...
                    <input id="or_number" type="text" class="form-control @error('or_number') is-invalid @enderror"
                        name="or_number" value="{{ $purchase->or_Number }}" required autocomplete="or_number" autofocus>
            ...
            <div class="form-group row mt-3">
                <div class="input-group col-md-6 pl-5 mx-auto mb-3 offset-md-3">
                    ...
                    <input id="transaction_date" type="date"
                        ...
                        value="{{ $purchase->transaction_date }}" required autocomplete="transaction_date" autofocus>
                ...
                <div class="input-group col-md-6 pr-5 mx-auto mb-3 offset-md-3">
                    ...
                    <input id="amount" type="number" class="form-control @error('amount') is-invalid @enderror"
                        name="amount" value="{{ $purchase->amount }}" required autocomplete="amount" autofocus>
            ...
            <div class="form-group row">
                <div class="input-group col-md-6 pl-5 mx-auto mb-3 offset-md-3">
                    ...
                    <input id="cheque_number" type="text"
                        ...
                        value="{{ $purchase->cheque->cheque_number }}" required autocomplete="cheque_number" autofocus>
              ...
              @endforeach
                ...
                <div class="input-group col-md-6 pr-5 mx-auto mb-3 offset-md-3">
                    ...
                    <select class="form-control @error('project_id') is-invalid @enderror" autocomplete="project_id"
                        autofocus name="project_id" value="{{ old('project_id') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-12 px-5 mx-auto">
                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" required
                        autocomplete="description" autofocus rows="5" placeholder="...">{{ $purchase->description }}</textarea>
            ...
            <div class="card-footer text-right mx-3 mb-3">
                ...
                <a href="/transaction_recorder/purchases" class="btn btn-secondary"><i class="ti-close"></i> Cancel</a>
            </div>
