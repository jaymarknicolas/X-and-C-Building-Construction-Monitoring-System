                    ...
                    <div id="tab-1" class="tab-pane show active">
                        <div class="pane-header">
                            <h3 class=" text-light"><i class="ti-user"></i>
                                {{ Auth()->user()->user_type == 1 ? 'Administrator' : '' }}
                                {{ Auth()->user()->user_type == 2 ? 'Fund Manager' : '' }}
                                {{ Auth()->user()->user_type == 3 ? 'Transaction Recorder' : '' }}
                            </h3>
                            <i class="fa fa-circle text-success "></i> <span
                                class="profile-user  text-light">{{ Auth()->user()->name }}</span>
                            <span class="float-right"><a href="{{ route('logout') }}"
                                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                    class="text-carolina">Log-Out</a>
                        ...
                        <div class="pane-body">
                            <div class="card bg-transparent mb-3">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        <input type="checkbox" checked data-toggle="toggle" data-size="sm"
                                            data-on="Yes" data-off="No"> Get Daily Feed
                                    </li>
                                    <li class="list-group-item">
                                    ...
                                    <li class="list-group-item">
                                        <input type="checkbox" checked data-toggle="toggle" data-size="sm"
                                            data-on="Yes" data-off="No"> Send Out Daily Report
                                    </li>
                                    <li class="list-group-item">
                                        <input type="checkbox" data-toggle="toggle" data-size="sm" data-on="Yes"
                                            data-off="No">
