...
class FundManagerProjectController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('fund-manager.project.index')->with('projects', $projects);
    }
    ...
    public function create()
    {
        ...
        return view('fund-manager.project.create')->with('clients', $clients);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/fund_manager/projects')->with('success', 'Added Successfully!');
    }
    ...
    public function show($id)
    {
        ...
        return view('fund-manager.project.show')
    ...
    public function edit($id)
    {
        $clients = Client::all();
        $project = Project::find($id);
        return view('fund-manager.project.edit')
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/fund_manager/projects')->with('success', 'Project Updated Successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/fund_manager/dashboard')->with('success', 'Status Updated Successfully!');
    }
}
