...
class FundManagerPDFMaker extends Controller
{
    //
    ...
    function generateProjectSummaryReport() {
        ...
        $pdf = PDF::loadView('fund-manager.reports.projectSummaryReport', [
        'projects'=>$projects,
        'expenses'=>$expenses,
    ...
    function chequesUtilizationReport($id) {
        ...
        // return $purchases;
         $pdf = PDF::loadView('fund-manager.reports.chequeUtilizationReport', [
            'cheques'=>$cheques,
            'purchases'=>$purchases,
            'timeToday'=>$todayTime,
    ...
    function disburseChequeSummary() {
        ...
        $pdf = PDF::loadView('fund-manager.reports.disbursementChequeSummary', [
            'purchases'=>$purchases,
            'timeToday'=>$todayTime,
    ...
    function gen($id) {
        ...
        $pdf = PDF::loadView('fund-manager.reports.projectInvoice', [
            'purchases'=> $purchases,
            'project'=> $project,
            'funds'=> $funds,
            'timeToday'=> $todayTime,
